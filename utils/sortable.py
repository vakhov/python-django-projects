...
class SortableModel(models.Model):
    ...
    def _get_class(self):
        """
        Returns class of objects to sort.
        Override it to be able to use complicated inherited models
        """
