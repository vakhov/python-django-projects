...
DATABASES = {
    'default': {
        ...
        'NAME': 'poligon',                      # Or path to database file if using sqlite3.
...
MEDIA_ROOT = '/work/dev/poligon/media/'
...
STATIC_ROOT = '/work/dev/poligon/app/static'
...
SECRET_KEY = '$sedq780d*3sy9ycg&)2@!b#j+vt(2uuhi*wsx*y9u4t2#=8kp'
