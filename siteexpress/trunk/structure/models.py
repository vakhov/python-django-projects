...
class Section(SortableModel):
    ...
    left_zone = models.OneToOneField(Zone, null=True, blank=True, editable=False, related_name='left_zone')
    third_zone = models.OneToOneField(Zone, null=True, blank=True, editable=False, related_name='third_zone')
    ...
    def delete(self, *args, **kwargs):
        self.zone.delete()
        self.left_zone.delete()
        self.third_zone.delete()
