...
(function($) {
    ...
    $.extend($.scrollable.prototype, {
        ...
        getCount: function() {
            var count = 0;
            $(this.opts.items, this.root).find(".item").each(function() {
                count++
            });
            return count;
        },
        ...
        seekTo: function(index, time) {
            ...
            var objPrev = $(this.opts.prev, this.root);
            var objNext = $(this.opts.next, this.root);


            if (!objPrev.hasClass('prev_active')) objPrev.addClass('prev_active');
            if (!objNext.hasClass('next_active')) objNext.addClass('next_active');

            if (index == 0) {
                objPrev.removeClass('prev_active');
            }
            if (index == (this.getCount() - this.opts.size)) {
                objNext.removeClass('next_active');
            }
            return true;
        },
