...
FILEBROWSER_URL_FILEBROWSER_MEDIA = settings.MEDIA_URL + 'filebrowser/'
FILEBROWSER_PATH_FILEBROWSER_MEDIA = settings.MEDIA_ROOT + 'filebrowser/'
FILEBROWSER_DIRECTORY = ''
FILEBROWSER_URL_TINYMCE = settings.STATIC_URL + "tiny_mce/tiny_mce.js"
FILEBROWSER_PATH_TINYMCE = settings.STATIC_URL + "tiny_mce/"
