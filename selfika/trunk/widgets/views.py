            ...
            <table>
                ...
                <tr>
                    <td colspan="2" style="text-align: center">
                        ...
                        <input type="button" name="submit_and_add_widget" value="%s" />
                        &nbsp;
                        <input type="submit" name="submit_widget_form" value="%s" />
                    </td>
                </tr>
            </table>
        </form>
    """ % (str(id), form.as_table(), path, u"Сохранить и добавить еще", u"Сохранить и закрыть")
